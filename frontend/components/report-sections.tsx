...
export function OverviewCard({ report }: { report: CycleReport }) {
  return (
    <Card>
...
export function DiagnosisSection({ report }: { report: CycleReport }) {
...
export function StrategySection({ report }: { report: CycleReport }) {
...
export function ActionItemsSection({ report }: { report: CycleReport }) {
  return (
    <div className="flex flex-col gap-4">
      <div>
...
export function ReferenceSection({ report }: { report: CycleReport }) {
  return (
    <div className="flex flex-col gap-4">
      <Card>
